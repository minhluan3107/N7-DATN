			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<form:form action="/admin/productsizeForm/save" method="post"
								modelAttribute="productsize" enctype="multipart/form-data">

								<div class="form-group">
									<label for="inputState">Kích thước</label>
									<form:select path="sizeId"
										onchange="document.location.href='/admin/productsizeForm/change/'+this.value"
						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-lg-4 mb-3">
									<form action="/admin/productsizeForm/form" method="post">
										<div class="input-group">
											<input type="text" name="keyword8"
												value="${sessionScope.keyword8}" class="form-control"
							...
							<table class="table table-bordered" width="100%" cellspacing="0">
								...
								<tbody>
									<c:forEach var="item" items="${prosizeItem.content}">
										<tr>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a href="/admin/productsizeForm/form/delete/${item.id}"
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-center">
									<li class="page-item ${(prosizeItem.number==0)?'disabled':''}"><a
										class="page-link"
										href="/admin/productsizeForm/form?p=${prosizeItem.number-1}"
										aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
									</a></li>
									<li class="page-item disabled"><a class="page-link"
										href="#">${prosizeItem.number+1}</a></li>
									<li
										class="page-item ${(prosizeItem.number>=prosizeItem.totalPages-1)?'disabled':''}"><a
										class="page-link"
										href="/admin/productsizeForm/form?p=${prosizeItem.number+1}"
