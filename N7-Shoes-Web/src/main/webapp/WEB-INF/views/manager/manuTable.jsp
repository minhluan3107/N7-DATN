				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-lg-8 ">
									<a href="/admin/manuForm/form" class="btn btn-primary"> <i
										class="fas fa-plus-square"></i> Thêm mới
									</a>
								</div>
								<div class="col-lg-4 mb-3">
									<form action="/admin/manuForm/list" method="post">
										<div class="input-group">
											<input type="text" name="keyword4"
												value="${sessionScope.keyword4}" class="form-control"
							...
							<table class="table table-bordered" width="100%" cellspacing="0">
								...
								<tbody>
									<c:forEach var="item" items="${manuItem.content}">
										<tr>
											<td>${item.name}</td>
											<td class="text-center"><img width="100" height="100"
												src="/upload/${item.image}"></td>
											<td>
												<a href="/admin/manuForm/list/load/${item.id}" class="btn btn-success">Sửa</a>
 ...
 --%>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a
															href="/admin/manuForm/list/delete/${item.id}"
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-center">
									<li class="page-item ${(manuItem.number==0)?'disabled':''}"><a
										class="page-link"
										href="/admin/manuForm/list?p=${manuItem.number-1}"
										aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
									</a></li>
									<li class="page-item disabled"><a class="page-link"
										href="#">${manuItem.number+1}</a></li>
									<li
										class="page-item ${(manuItem.number>=manuItem.totalPages-1)?'disabled':''}"><a
										class="page-link"
										href="/admin/manuForm/list?p=${manuItem.number+1}"
