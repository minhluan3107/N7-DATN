			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<form:form action="/admin/productcateForm/save" method="post"
						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-lg-4 mb-3">
									<form action="/admin/productcateForm/form" method="post">
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a href="/admin/productcateForm/form/delete/${item.id}"
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-center">
									<li class="page-item ${(procateItem.number==0)?'disabled':''}"><a
										class="page-link"
										href="/admin/productcateForm/form?p=${procateItem.number-1}"
