...
<title>N7-Shoes Xin Chào Quản Lý!</title>tle>
<link
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-lg-8 ">
									<a href="/admin/colorForm/form" class="btn btn-primary"> <i
										class="fas fa-plus-square"></i> Thêm mới
									</a>
								</div>
								<div class="col-lg-4 mb-3">
									<form action="/admin/colorForm/list" method="post">
										<div class="input-group">
											<input type="text" name="keyword7"
												value="${sessionScope.keyword7}" class="form-control"
							...
							<table class="table table-bordered" width="100%" cellspacing="0">
								...
								<tbody>
									<c:forEach var="item" items="${colorItem.content}">
										<tr>
											<td>${item.name}</td>
											<td>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a href="/admin/colorForm/list/delete/${item.id}"
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-center">
									<li class="page-item ${(colorItem.number==0)?'disabled':''}"><a
										class="page-link"
										href="/admin/colorForm/list?p=${colorItem.number-1}"
										aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
									</a></li>
									<li class="page-item disabled"><a class="page-link"
										href="#">${colorItem.number+1}</a></li>
									<li
										class="page-item ${(colorItem.number>=colorItem.totalPages-1)?'disabled':''}"><a
										class="page-link"
										href="/admin/colorForm/list?p=${colorItem.number+1}"
