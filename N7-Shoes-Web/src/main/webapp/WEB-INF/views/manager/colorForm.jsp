			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<form:form action="/admin/colorForm/form" method="post"
								modelAttribute="colorModel" enctype="multipart/form-data">
								...
								<button formaction="/admin/colorForm/list" formmethod="get"
