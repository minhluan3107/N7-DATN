				...
				<div class="bg-light p-30">
					...
					<div class="tab-content">
						...
						<div class="tab-pane fade" id="tab-pane-3">
							<div class="row">
								<div class="col-md-6">
									<h4 class="mb-4">1 bình luận cho sản phẩm: "${loadInfo.name}"</h4>
									<div class="media mb-4">
										<img src="/user/img/user.jpg" alt="Image"
											class="img-fluid mr-3 mt-1" style="width: 45px;">
										<div class="media-body">
											<h6>
												MinhLuan<small> - <i>01 7 2002</i></small>
											</h6>
											...
											<p>Chất lượng sản phẩm tốt, Giao hàng hơi bị nhanh à nha...</p>
										</div>
									</div>
								</div>
								<div class="col-md-6">
									...
									<div class="form-group">
										<label for="name">Họ và tên *</label> <input type="text"
									...
									<div class="form-group mb-0">
										<input type="submit" value="Đánh giá ngay"
