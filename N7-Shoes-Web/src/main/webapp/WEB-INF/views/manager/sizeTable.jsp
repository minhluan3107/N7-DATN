				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-lg-8 ">
									<a href="/admin/sizeForm/form" class="btn btn-primary"> <i
										class="fas fa-plus-square"></i> Thêm mới
									</a>
								</div>
								<div class="col-lg-4 mb-3">
									<form action="/admin/sizeForm/list" method="post">
										<div class="input-group">
											<input type="text" name="keyword6"
												value="${sessionScope.keyword6}" class="form-control"
							...
							<table class="table table-bordered" width="100%" cellspacing="0">
								...
								<tbody>
									<c:forEach var="item" items="${sizeItem.content}">
										<tr>
											<td>${item.name}</td>
											<td>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a href="/admin/sizeForm/form/delete/${item.id}"
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-center">
									<li class="page-item ${(sizeItem.number==0)?'disabled':''}"><a
										class="page-link"
										href="/admin/sizeForm/list?p=${sizeItem.number-1}"
										aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
									</a></li>
									<li class="page-item disabled"><a class="page-link"
										href="#">${sizeItem.number+1}</a></li>
									<li
										class="page-item ${(sizeItem.number>=sizeItem.totalPages-1)?'disabled':''}"><a
										class="page-link"
										href="/admin/sizeForm/list?p=${sizeItem.number+1}"
