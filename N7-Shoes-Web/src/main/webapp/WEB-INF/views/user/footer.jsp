	...
	<div class="container-fluid bg-dark text-secondary mt-5 pt-5">
		<div class="row px-xl-5 pt-5">
			<div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
				...
				<p class="mb-4">Liên hệ ngay để được cập nhật sớm nhất những thông tin hữu ích, ữu đãi vô cùng hấp dẫn và những món quà bất ngờ từ N7 Shoes</p>
				<p class="mb-2">
					<i class="fa fa-map-marker-alt text-primary mr-3"></i>CVPM Quang Trung, Q12
				</p>
				<p class="mb-2">
					<i class="fa fa-envelope text-primary mr-3"></i>holypanda123@gmail.com
				</p>
				<p class="mb-0">
					<i class="fa fa-phone-alt text-primary mr-3"></i>0862346467
				</p>
			</div>
			<div class="col-lg-8 col-md-12">
				<div class="row">
					<div class="col-md-4 mb-5">
						...
						<div class="d-flex flex-column justify-content-start">
							<a class="text-secondary mb-2" href="#"><i
								...
								class="fa fa-angle-right mr-2"></i>Giới thiệu</a> <a
								class="text-secondary mb-2" href="#"><i
					...
					<div class="col-md-4 mb-5">
						...
						<div class="d-flex flex-column justify-content-start">
							<a class="text-secondary mb-2" href="#"><i
								class="fa fa-angle-right mr-2"></i>Trang chủ</a> <a
								class="text-secondary mb-2" href="#"><i
								class="fa fa-angle-right mr-2"></i>Về cửa hàng</a> <a
								class="text-secondary mb-2" href="#"><i
								class="fa fa-angle-right mr-2"></i>Chi tiết cửa hàng</a> <a
								class="text-secondary mb-2" href="#"><i
								class="fa fa-angle-right mr-2"></i>Giỏ hàng</a> <a
								class="text-secondary mb-2" href="#"><i
								class="fa fa-angle-right mr-2"></i>Đơn hàng</a> 
						</div>
					</div>
					<div class="col-md-4 mb-5">
						<h5 class="text-secondary text-uppercase mb-4">Nhận Thông tin</h5>
						<p>Đăng ký email để nhận những thông tin khuyến mãi mới nhất</p>
						<form action="">
