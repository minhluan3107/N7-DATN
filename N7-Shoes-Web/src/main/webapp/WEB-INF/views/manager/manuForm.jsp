		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Form Thương Hiệu</h1>
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<form:form action="/admin/manuForm/form" method="post"
								modelAttribute="manuForm" enctype="multipart/form-data">
								<div class="form-group">
									<label for="inputEmail4">Tên thương hiệu</label>
								...
								<div class="form-group">
									<label for="inputEmail4">Thông tin</label>
									<form:textarea rows="3" path="information" cssClass="form-control"
										cssErrorClass="form-control is-invalid" id="inputEmail4" />
									<form:errors path="information" cssClass="invalid-feedback"></form:errors>
								</div>

								<div class="form-group d-flex justify-content-center">
									<img src="/upload/${sessionScope.nameImage2}"
								...
								<c:if test="${edit2}">
									<button
										formaction="/admin/manuForm/form/edit/${sessionScope.id2}"
										class="btn btn-primary">
										<i class="fas fa-pen"></i> Cập nhật
									</button>
								</c:if>

								<button formaction="/admin/manuForm/refresh"
									class="btn btn-info">
									<i class="fas fa-redo-alt"></i> Làm mới
								</button>
								<button formaction="/admin/manuForm/list" formmethod="get"
