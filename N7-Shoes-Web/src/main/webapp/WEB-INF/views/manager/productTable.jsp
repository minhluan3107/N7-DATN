		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Danh Sách Sản Phẩm</h1>
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-lg-8 ">
									<a href="/admin/productForm/form" class="btn btn-primary"> <i
										class="fas fa-plus-square"></i> Thêm mới
									</a>
								</div>
								<div class="col-lg-4 mb-3">
									<form action="/admin/productForm/list" method="post">
							...
							<table class="table table-bordered" width="100%" cellspacing="0">
								...
								<tbody>
									<c:forEach var="item" items="${productItem.content}">
										<tr>
											<td>${item.name}</td>
											...
											<th>${item.status?'Có':'Không'}</th>
											<td>
												<a href="/admin/productForm/list/load/${item.id}" class="btn btn-success">Sửa</a>
												<a href="/admin/productForm/list/enable/${item.id}" class="btn btn-info">Đổi TT</a>
 ...
 --%>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a
															href="/admin/productForm/list/delete/${item.id}"
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-center">
									<li class="page-item ${(productItem.number==0)?'disabled':''}"><a
										class="page-link"
										href="/admin/productForm/list?p=${productItem.number-1}"
										aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
									</a></li>
									<li class="page-item disabled"><a class="page-link"
										href="#">${productItem.number+1}</a></li>
									<li
										class="page-item ${(productItem.number>=productItem.totalPages-1)?'disabled':''}"><a
										class="page-link"
										href="/admin/productForm/list?p=${productItem.number+1}"
