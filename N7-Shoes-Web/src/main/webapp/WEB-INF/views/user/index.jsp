					...
					<div class="carousel-inner">
						<div class="carousel-item position-relative active"
							...
							<img class="position-absolute w-100 h-100"
								src="/user/img/carousel-1.1.jpg" style="object-fit: cover;">
							<div
						...
						<div class="carousel-item position-relative"
							style="height: 700px;">
							<img class="position-absolute w-100 h-100"
								src="/user/img/carousel-2.2.jpg" style="object-fit: cover;">
							<div
								class="carousel-caption d-flex flex-column align-items-center justify-content-center">
								<div class="p-3" style="max-width: 700px;">
									<h1
						...
						<div class="carousel-item position-relative"
							style="height: 700px;">
							<img class="position-absolute w-100 h-100"
								src="/user/img/carousel-3.3.jpg" style="object-fit: cover;">
							<div
								class="carousel-caption d-flex flex-column align-items-center justify-content-center">
								<div class="p-3" style="max-width: 700px;">
									<h1
		...
		<div class="row px-xl-5">
			<div class="col-md-6">
				<div class="product-offer mb-30" style="height: 300px;">
					<img class="img-fluid" src="/user/img/carousel-1.1.jpg" alt="">
					<div class="offer-text">
						<h6 class="text-white text-uppercase">Giảm giá 60%</h6>
						<h3 class="text-white mb-3">Ưu đãi đặc biệt</h3>
			...
			<div class="col-md-6">
				<div class="product-offer mb-30" style="height: 300px;">
					<img class="img-fluid" src="/user/img/carousel-2.2.jpg" alt="">
					<div class="offer-text">
						<h6 class="text-white text-uppercase">Giảm giá 60%</h6>
						<h3 class="text-white mb-3">Ưu đãi đặc biệt</h3>
						<a href="#" class="btn btn-primary">Mua ngay</a>
