				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-lg-8 ">
									<a href="/admin/categoryForm/form" class="btn btn-primary"> <i
										class="fas fa-plus-square"></i> Thêm mới
									</a>
								</div>
								<div class="col-lg-4 mb-3">
									<form action="/admin/categoryForm/list" method="post">
								...
								<tbody>
									<c:forEach var="item" items="${userItem.content}">
										<tr>
											...
											<td>
												<a href="/admin/categoryForm/list/load/${item.id}" class="btn btn-success">Sửa</a>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a
															href="/admin/categoryForm/list/delete/${item.id}"
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-center">
									<li class="page-item ${(userItem.number==0)?'disabled':''}"><a
										class="page-link"
										href="/admin/categoryForm/list?p=${userItem.number-1}"
